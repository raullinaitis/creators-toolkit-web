 ...
 * 
 * Converted from snippets/ds-btn-primary.liquid
 * Primary button with gradient fill, icon support, and size variants
 */
...
export function ButtonPrimary({
  ...
  const classes = `ds-btn-primary-wrapper ${sizeClass}${className ? ` ${className}` : ''}`
