 ...
 * Media Kit Page
 * 
 * Provides brand assets, colors, typography, and contact information
 * for media partners and collaborators
 */
...
export const metadata = {
  title: 'Media Kit | Creators Toolkit',
  description: 'Brand assets, colors, typography, and contact information for media partners',
}
